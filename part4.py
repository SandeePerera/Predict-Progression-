...
"""
                ...
                #Software Development - Course Work part 1111
            ...
            if (fail==0 or fail==20 or fail==40 or fail==60 or fail==80 or fail==100 or fail==120):
                if (credit_total<=120):
                    ...
                    if cont=="y":
                        ...
                        print("Progress",count1,"|","Trailer",count2,"|","Retriver",count3,"|","Exclude",count4)
                        for row in range(max(count1,count2,count3,count4)):
